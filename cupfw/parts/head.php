...
<html lang="en" class="no-js">
  <head>
    ...
    <!--<link href="<?php bloginfo( 'template_url' ); ?>/backstage/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet">-->
    ...
    <!--<link href="<?php bloginfo( 'template_url' ); ?>/css/min.css" rel="stylesheet">-->
    ...
    <!--<link rel="shortcut icon" href="<?php bloginfo( 'template_url' ); ?>/img/icons/favicon.ico">-->
